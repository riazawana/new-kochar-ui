...
const userRoutes: Routes =[
  {path:'',component: ZoneDeviceComponent , canActivate:[AuthGuard]},
    ...
    {path:'editenergymeter/:id/:client',component:EditenergyMeterComponent,canActivate:[AuthGuard]},
    ...
    {path:'viewenergy/:id/:client',component:ViewenergyComponent,canActivate:[AuthGuard]},
